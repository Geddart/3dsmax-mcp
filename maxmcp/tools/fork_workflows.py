...
def inspect_active_target(
    ...
    from .fork_snapshots import get_scene_snapshot, get_selection_snapshot
...
def create_object_verified(
    ...
    from .fork_snapshots import get_scene_delta
...
def assign_material_verified(
    ...
    return json.dumps({
        ...
        "materialSlots": _load_json(get_material_slots(names[0]), {}) if names else {},
        "delta": delta,
